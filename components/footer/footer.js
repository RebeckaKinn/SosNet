...
export function footer(){
    ...
    <footer role="footer">
        ...
        <div class="flex row flex-gap-2rem ">
            ...
            <svg class="footer-some-icons main-color-3" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
        ...
        <section>
            <p class="text-align-center footer-links">&copy; 2025 SosNet. All rights reserved.</p>
        </section>
    </footer>
